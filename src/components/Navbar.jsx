...
export default function Navbar({ navigateToPage, isHomePage }) {
    ...
    <nav className="bg-[#f4f6f4] text-emerald-900 sticky top-0 z-50 shadow-md border-b border-gray-200">
        ...
        <div className="flex items-center justify-between h-24">
          ...
          <div className="hidden xl:flex items-center space-x-1 text-xs font-bold text-emerald-800 tracking-wide">
            ...
            <a 
              ...
              onClick={isHomePage ? undefined : () => navigateToPage('home')}
              className={`flex items-center px-2 py-2 ${isHomePage ? 'text-[#c19a28] border-b-2 border-[#c19a28]' : 'hover:text-[#c19a28] rounded-md hover:bg-emerald-50'} transition-all`}
            >
      ...
      {isMobileMenuOpen && (
        <div className="xl:hidden bg-white border-t border-gray-100 px-4 pt-3 pb-6 space-y-1 shadow-2xl max-h-[85vh] overflow-y-auto">
          <a href="#" onClick={() => navigateToPage('home')} className="block px-3 py-2 text-[#c19a28] font-bold bg-amber-50 rounded-lg">INICIO</a>

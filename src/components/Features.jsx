      ...
      <div className="grid md:grid-cols-3 gap-6">
        {['La Palabra', 'La Liturgia', 'La Caridad'].map((title, i) => (
          <a 
            key={i} 
            href="#funciones"
            className="bg-white p-5 rounded-xl shadow-lg border border-slate-100 flex items-center space-x-4 border-l-4 border-[#c19a28] transform hover:-translate-y-2 hover:shadow-xl transition-all duration-300 cursor-pointer block"
          >
